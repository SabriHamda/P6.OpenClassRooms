 ...
 */
final class Version20181112172806 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE category_id category_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
